...
const createQuotation = async (req, res, next) => {
    try {
        ...
        // Bind to the authenticated org when present; otherwise keep the
        // submitted sellerId (or the model default) so the seller can list it back.
        if (req.auth?.orgId) payload.sellerId = String(req.auth.orgId);
